...
public class CanonUltraPerform implements IPrintTasks, IFax, IAuthenticator, IPrintFromOutside, IPrintScanner {
	...
	@Override
	public boolean fax(String content, String phoneNo) {
		// TODO Auto-generated method stub
		return false;
	}
